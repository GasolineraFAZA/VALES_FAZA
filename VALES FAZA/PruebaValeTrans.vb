...
Public Class PruebaValeTrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GRUPO_FAZA.PruebaValeTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPruebaValeTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PruebaValeTrans = New PruebaValeTrans()
        rpt.Site = Me.Site
        Return rpt
    End Function
