...
Public Class RecepcionValeAnexo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VALES_FAZA.RecepcionValeAnexo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecepcionValeAnexo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecepcionValeAnexo = New RecepcionValeAnexo()
        rpt.Site = Me.Site
        Return rpt
    End Function
