...
Public Class RptValeTrasns
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VALES_FAZA.RptValeTrasns.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptValeTrasns
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptValeTrasns = New RptValeTrasns()
        rpt.Site = Me.Site
        Return rpt
    End Function
