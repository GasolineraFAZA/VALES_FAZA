...
Public Class ValesTransferencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VALES_FAZA.ValesTransferencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdValeTrans() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedValesTransferencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValesTransferencia = New ValesTransferencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
