...
Public Class RptValesAnexo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VALES_FAZA.RptValesAnexo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptValesAnexo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptValesAnexo = New RptValesAnexo()
        rpt.Site = Me.Site
        Return rpt
    End Function
