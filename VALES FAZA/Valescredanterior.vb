...
Public Class Valescredanterior
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VALES_FAZA.Valescredanterior.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValescredanterior
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Valescredanterior = New Valescredanterior()
        rpt.Site = Me.Site
        Return rpt
    End Function
